...
@Table(name = "auth_base_group_member")
public class AuthGroupMemberPo implements Serializable {
    @Id
    @Column(name = "auth_group_member_id")
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Integer authGroupMemberId;
    ...
    /**
     * @return auth_group_member_id
     */
    public Integer getAuthGroupMemberId() {
        return authGroupMemberId;
    }

    /**
     * @param authGroupMemberId
     */
    public void setAuthGroupMemberId(Integer authGroupMemberId) {
        this.authGroupMemberId = authGroupMemberId;
    }
    ...
    public String toString() {
        ...
        sb.append(", authGroupMemberId=").append(authGroupMemberId);
