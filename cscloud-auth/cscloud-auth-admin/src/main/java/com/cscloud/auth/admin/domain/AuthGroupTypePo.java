...
@Table(name = "auth_base_group_type")
public class AuthGroupTypePo implements Serializable {
    @Id
    @Column(name = "auth_group_type_id")
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Integer authGroupTypeId;
    ...
    /**
     * @return auth_group_type_id
     */
    public Integer getAuthGroupTypeId() {
        return authGroupTypeId;
    }

    /**
     * @param authGroupTypeId
     */
    public void setAuthGroupTypeId(Integer authGroupTypeId) {
        this.authGroupTypeId = authGroupTypeId;
    }
    ...
    public String toString() {
        ...
        sb.append(", authGroupTypeId=").append(authGroupTypeId);
